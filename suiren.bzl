...
def define_suiren():
	...
	"mm/zsmalloc.ko",
	"drivers/gpio/gpio-jingshang-n801.ko",
	"drivers/tty/n_gsm.ko",
        "drivers/input/fingerprint/goodix_fod/goodix_fod.ko",
	"drivers/usb/dwc3/xm-extcon-usb-gpio.ko",
        "drivers/usb/repeater/repeater-i2c-eusb2.ko",
	"drivers/spi/spidev.ko",
	"drivers/pci/brcm_xgbe/brcm_xgbe.ko",
	"drivers/i2c/i2c-dev.ko",
	"drivers/net/wireless/bcmdhd/bcmdhd.ko",
	"drivers/gpio/gpio_control.ko",
        ]
