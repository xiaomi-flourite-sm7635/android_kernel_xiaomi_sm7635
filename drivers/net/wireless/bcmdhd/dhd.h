...
void dhd_sched_kworker_on(int cpu_integer, struct work_struct *work);
bool dhd_sched_delayed_work_on(int cpu_integer, struct delayed_work *d_work, unsigned long delay);

#define DHD_KWORKER_CPUBITMAP 0x6E
...
#if (defined(WLTDLS) && defined(PCIE_FULL_DONGLE)) || defined(WL_DHD_XR_PCISDIO)
...
#endif /* (WLTDLS && PCIE_FULL_DONGLE) || WL_DHD_XR_PCISDIO */
...
#define DHD_COMMON_DUMP_PATH	"/data/vendor/tombstones/wifi/"
#else /* Default */
...
#if defined(PCIE_FULL_DONGLE) || defined(WL_DHD_XR_PCISDIO)
...
#endif /* PCIE_FULL_DONGLE || WL_DHD_XR_PCISDIO */
...
/* End - Variables to track Bus Errors */
...
#if defined(BCMPCIE) || defined(WL_DHD_XR_PCISDIO)
	int   d3ackcnt_timeout;		/* counter d3ack timeout to send HANG */
#endif /* BCMPCIE || WL_DHD_XR_PCISDIO */
...
#if defined(WLTDLS) || defined(WL_DHD_XR_PCISDIO)
	bool tdls_enable;
#endif /* WLTDLS || WL_DHD_XR_PCISDIO */
	...
	uint32 store_idx;
	uint32 sent_idx;
#if defined(DHDTCPACK_SUPPRESS) || defined(WL_DHD_XR_PCISDIO)
...
#endif /* DHDTCPACK_SUPPRESS || WL_DHD_XR_PCISDIO */
...
#endif /* DHD_L2_FILTER */
#if defined(DHD_SSSR_DUMP) || defined(WL_DHD_XR_PCISDIO)
	bool sssr_inited;
...
#endif /* DHD_SSSR_DUMP || WL_DHD_XR_PCISDIO */
	uint8 *soc_ram;
...
#if defined(DHD_H2D_LOG_TIME_SYNC) || defined(WL_DHD_XR_PCISDIO)
...
#endif /* DHD_H2D_LOG_TIME_SYNC || WL_DHD_XR_PCISDIO */
	int wlc_ver_major;
	int wlc_ver_minor;
