...
static int wcd_usbss_probe(struct i2c_client *i2c)
{
	...
	int rc = 0, i;
	unsigned int ver = 0;
	uint32_t platform_id = 0, hw_country_ver = 0;
	...
	if ( platform_id == HARDWARE_PROJECT_N18 ) {
		/* resolve the problem of usb ovp */
	...
	} else if (platform_id == HARDWARE_PROJECT_O81 || platform_id == HARDWARE_PROJECT_O82) {
