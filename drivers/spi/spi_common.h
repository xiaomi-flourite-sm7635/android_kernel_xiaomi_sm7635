...
void check_bcm89272_state_and_reset(void);
...
#define BRCM_OP_ADD 1
#define BRCM_OP_DEL 2

#define BRCM_SPI_OP_BUSY   (-16)
#define BRCM_SPI_OP_ERROR  (-1)
